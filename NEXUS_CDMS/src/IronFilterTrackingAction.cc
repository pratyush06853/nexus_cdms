//
/// \file IronFilter/src/IronFilterTrackingAction.cc
/// \brief Implementation of the IronFilterTrackingAction class
//
//
...
IronFilterTrackingAction::IronFilterTrackingAction(IronFilterEventAction* eventAction)
...
void IronFilterTrackingAction::PreUserTrackingAction(const G4Track* track)
{
/*
